...
namespace ECommerceWeb.Controllers
{
    ...
    public class ProductController : BaseController
    {
        ...
        public ActionResult i()
        {
            ...
            var products = context.Products.OrderByDescending(x => x.AddedDate).Where(x=>x.IsDeleted==false ||x.IsDeleted==null).ToList();
        ...
        public ActionResult Edit(int id=0)
        {
            ...
            var categories = context.Categories.Where(x=>x.IsDeleted==false || x.IsDeleted==null ).Select(x => new SelectListItem()
            {
                Text = x.Name,
                Value = x.Id.ToString()
            }).ToList();
